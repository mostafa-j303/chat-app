...
import { MJdataTableColumns2, MJuserData, userData, MJinvestData } from "./components/table/TableData";
  ...
  return (
    <React.Fragment>
      ...
      <div className="nk-tb-list">
        ...
        {Array.isArray(props.data.investData) && props.data.investData.map((item) => {
