...
// my HR import
import FormRequest from "../pages/pre-built/MY_HR/FormRequest";
import JobDescription from "../pages/pre-built/MY_HR/JobDescription";
import PerformanceAppraisal from "../pages/pre-built/MY_HR/PerformanceAppraisal";
import ResumeCV from "../pages/pre-built/MY_HR/ResumeCV";
...
import Mostafa from "../pages/mostafa";
import MJCalenderApp from "../components/partials/calender/MjCalender";
import CustomDragDrop from "../pages/pre-built/MY_HR/CustomDragDrop";
  ...
  return (
    <Suspense fallback={<div />}>
      <Switch>
        ...
        <Route
          exact
          path={`${process.env.PUBLIC_URL}/MY_HR`}
          render={(props) => <Mostafa {...props} actions={true} className={true} isCompact={true} selectableRows={true} />}
        ></Route>
       ...
       {/* {my hr here here here} */}
       
        <Route exact path={`${process.env.PUBLIC_URL}/MY_HR`} component={Mostafa}></Route>
        <Route exact path={`${process.env.PUBLIC_URL}/MY_HR/MJCalendarApp/:userId/:userN`} component={MJCalenderApp}></Route>
        <Route exact path={`${process.env.PUBLIC_URL}/MY_HR/FormRequest`} component={FormRequest}></Route>
        <Route exact path={`${process.env.PUBLIC_URL}/MY_HR/JobDescription`} component={JobDescription}></Route>  
        <Route exact path={`${process.env.PUBLIC_URL}/MY_HR/PerformanceAppraisal`} component={PerformanceAppraisal}></Route> 
        <Route exact path={`${process.env.PUBLIC_URL}/MY_HR/ResumeCV`} component={ResumeCV}></Route>
        <Route exact path={`${process.env.PUBLIC_URL}/MY_HR/DragDrop`} component={CustomDragDrop}></Route>
